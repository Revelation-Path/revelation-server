...
impl SongbookService {
    ...
    pub async fn list_songbooks(&self) -> AppResult<Vec<Songbook>> {
        use revelation_shared::ports::SongbookRead;
    ...
    pub async fn list_songs(
        ...
        use revelation_shared::ports::SongRead;
    ...
    pub async fn search_songs(
        ...
        use revelation_shared::ports::SongSearch;
    ...
    pub async fn create_song(&self, song: CreateSong) -> AppResult<Song> {
        use revelation_shared::ports::SongWrite;
    ...
    pub async fn list_favorites(&self, user_id: Uuid) -> AppResult<Vec<SongSummary>> {
        use revelation_shared::ports::SongFavorites;
    ...
    pub async fn list_recent(
        ...
        use revelation_shared::ports::SongHistory;
